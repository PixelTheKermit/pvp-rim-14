...
namespace Content.Shared.CCVar
{
    ...
    public sealed class CCVars : CVars
    {
        ...
        public static readonly CVarDef<string> RulesFile =
            CVarDef.Create("server.rules_file", "OR14 Rules.txt", CVar.REPLICATED | CVar.SERVER);
        ...
        /// </summary>
        public static readonly CVarDef<int>
            GameMaxCharacterSlots = CVarDef.Create("game.maxcharacterslots", 128, CVar.ARCHIVE | CVar.SERVERONLY);
        ...
        public static readonly CVarDef<string> DatabaseSqliteDbPath =
            CVarDef.Create("database.sqlite_dbpath", "preferences-or14.db", CVar.SERVERONLY);
        ...
        public static readonly CVarDef<string> WhitelistReason =
            CVarDef.Create("whitelist.reason", "whitelist-not-whitelisted-or", CVar.SERVERONLY);
